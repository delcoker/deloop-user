package com.deloop.user.data.auth.rest;

import com.deloop.user.data.exceptions.ApplicationException;
import com.deloop.user.data.exceptions.EntityAlreadyExistsException;
import com.deloop.user.data.exceptions.EntityConflictsException;
import com.deloop.user.data.exceptions.EntityNotFoundException;
