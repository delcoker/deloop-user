...
import com.deloop.user.data.auth.security.*;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter implements EnvironmentAware {
    ...
    static {
        System.setProperty("JWT_TOKEN_SECRET_KEY", "foo");
    }
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // logs out.
        customizeFilters(http.addFilterBefore(new JwtAuthenticationFilter(jwtTokenService), LogoutFilter.class));
