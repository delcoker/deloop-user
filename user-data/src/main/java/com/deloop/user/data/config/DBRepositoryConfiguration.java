...
//    }
    ...
    @Bean
    IUserDetailRepository userDetailRepository(@Qualifier("dbEbeanService") IDBEbeanService dbEbeanService) {
        return new UserDetailRepository(dbEbeanService.getDb());
    }
