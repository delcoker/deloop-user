...
alter table users drop foreign key fk_users_userTypeId;
drop index ix_users_userTypeId on users;
...
alter table user_permissions_user_types drop foreign key fk_user_permissions_user_types_user_permissions;
drop index ix_user_permissions_user_types_user_permissions on user_permissions_user_types;

alter table user_permissions_user_types drop foreign key fk_user_permissions_user_types_user_types;
drop index ix_user_permissions_user_types_user_types on user_permissions_user_types;
...
drop table if exists user_permissions_user_types;
