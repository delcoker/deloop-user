...
import com.deloop.user.core.services.UrlService;
...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    private static String REGISTRATION_ENDPOINT = "/registration/confirm?token=";

    @Override
    public String register(RegistrationRequest registrationRequest) throws EmailInvalidException, EmailIsAlreadyTakenException {
        boolean isValid = emailValidatorService.test(registrationRequest.getEmail());
        if (!isValid) {
